...
module Stripe
  class << self
    ...
    # #set_app_info.
    #
    # source://stripe//lib/stripe.rb#98
    def app_info; end

    # source://stripe//lib/stripe.rb#102
    ...
    #
    # source://stripe//lib/stripe.rb#111
...
#
# source://stripe//lib/stripe/errors.rb#55
...
#
# source://stripe//lib/stripe/errors.rb#62
...
module Stripe::APIOperations::Request
  ...
  def execute_resource_request(method, url, params = T.unsafe(nil), opts = T.unsafe(nil), usage = T.unsafe(nil)); end
  ...
  #
  # source://stripe//lib/stripe/api_operations/request.rb#115
  def request(method, url, params = T.unsafe(nil), opts = T.unsafe(nil), usage = T.unsafe(nil)); end

  private

  # source://stripe//lib/stripe/api_operations/request.rb#130
  def request_stripe_object(method:, path:, params:, opts: T.unsafe(nil), usage: T.unsafe(nil)); end
...
module Stripe::APIOperations::Request::ClassMethods
  ...
  def execute_resource_request_stream(method, url, params = T.unsafe(nil), opts = T.unsafe(nil), usage = T.unsafe(nil), &read_body_chunk_block); end
  ...
  # @raise [ArgumentError]
  #
  # source://stripe//lib/stripe/api_operations/request.rb#96
  def error_on_invalid_params(params); end

  # source://stripe//lib/stripe/api_operations/request.rb#82
  ...
  # source://stripe//lib/stripe/api_operations/request.rb#28
  def request_stripe_object(method:, path:, params:, opts: T.unsafe(nil), usage: T.unsafe(nil)); end

  # source://stripe//lib/stripe/api_operations/request.rb#104
...
class Stripe::Account < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/account.rb#28
  def persons(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/account.rb#37
  ...
  class << self
    ...
    # source://stripe//lib/stripe/resources/account.rb#46
    def persons(account, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/api_operations/nested_resource.rb#22
    def persons_url(id, nested_id = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/account.rb#137
    def protected_fields; end

    # source://stripe//lib/stripe/resources/account.rb#55
...
# to Stripe's servers.
#
# source://stripe//lib/stripe/errors.rb#49
...
# some reason.
#
# source://stripe//lib/stripe/errors.rb#67
...
class Stripe::Climate::Order < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/climate/order.rb#15
  def cancel(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  class << self
    # source://stripe//lib/stripe/resources/climate/order.rb#24
...
class Stripe::Customer < ::Stripe::APIResource
  ...
  class << self
    ...
    # source://stripe//lib/stripe/resources/customer.rb#58
    ...
    # source://stripe//lib/stripe/resources/customer.rb#67
    ...
    # source://stripe//lib/stripe/resources/customer.rb#76
    ...
    # source://stripe//lib/stripe/resources/customer.rb#104
    def search(params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/customer.rb#108
    def search_auto_paging_each(params = T.unsafe(nil), opts = T.unsafe(nil), &blk); end
    ...
    # source://stripe//lib/stripe/resources/customer.rb#121
...
# source://stripe//lib/stripe/resources/customer.rb#134
class Stripe::Customer::TestHelpers < ::Stripe::APIResourceTestHelpers
  # source://stripe//lib/stripe/resources/customer.rb#146
  def fund_cash_balance(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  class << self
    # source://stripe//lib/stripe/resources/customer.rb#137
    def fund_cash_balance(customer, params = T.unsafe(nil), opts = T.unsafe(nil)); end
  end
end

# source://stripe//lib/stripe/resources/customer.rb#135
...
# source://stripe//lib/stripe.rb#55
...
class Stripe::Dispute < ::Stripe::APIResource
  ...
  class << self
    # source://stripe//lib/stripe/resources/dispute.rb#25
...
# improperly.
#
# source://stripe//lib/stripe/errors.rb#81
...
# parameters.
#
# source://stripe//lib/stripe/errors.rb#86
...
class Stripe::Invoice < ::Stripe::APIResource
  ...
  class << self
    ...
    # source://stripe//lib/stripe/resources/invoice.rb#153
    def search_auto_paging_each(params = T.unsafe(nil), opts = T.unsafe(nil), &blk); end
    ...
    # source://stripe//lib/stripe/resources/invoice.rb#140
...
class Stripe::Issuing::Authorization < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/issuing/authorization.rb#53
  def test_helpers; end
...
# source://stripe//lib/stripe/resources/issuing/authorization.rb#57
class Stripe::Issuing::Authorization::TestHelpers < ::Stripe::APIResourceTestHelpers
  # source://stripe//lib/stripe/resources/issuing/authorization.rb#105
  def capture(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/issuing/authorization.rb#114
  def expire(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/issuing/authorization.rb#123
  def increment(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/issuing/authorization.rb#132
  def reverse(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  class << self
    # source://stripe//lib/stripe/resources/issuing/authorization.rb#60
    def capture(authorization, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/issuing/authorization.rb#69
    def create(params = T.unsafe(nil), opts = T.unsafe(nil)); end
    ...
    # source://stripe//lib/stripe/resources/issuing/authorization.rb#87
    def increment(authorization, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/issuing/authorization.rb#96
    def reverse(authorization, params = T.unsafe(nil), opts = T.unsafe(nil)); end
  end
end

# source://stripe//lib/stripe/resources/issuing/authorization.rb#58
...
class Stripe::Issuing::Transaction < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/issuing/transaction.rb#17
  def test_helpers; end
end
...
class Stripe::Issuing::Transaction::TestHelpers < ::Stripe::APIResourceTestHelpers
  ...
  class << self
    # source://stripe//lib/stripe/resources/issuing/transaction.rb#24
    def create_force_capture(params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/issuing/transaction.rb#33
    def create_unlinked_refund(params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/issuing/transaction.rb#42
    def refund(transaction, params = T.unsafe(nil), opts = T.unsafe(nil)); end
  end
end

# source://stripe//lib/stripe/resources/issuing/transaction.rb#22
...
# source://stripe//lib/stripe.rb#60
...
#
# source://stripe//lib/stripe/errors.rb#140
...
#
# source://stripe//lib/stripe/errors.rb#147
...
#
# source://stripe//lib/stripe/errors.rb#152
...
#
# source://stripe//lib/stripe/errors.rb#156
...
#
# source://stripe//lib/stripe/errors.rb#161
...
# parameter is specified.
#
# source://stripe//lib/stripe/errors.rb#166
...
class Stripe::PaymentMethodDomain < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/payment_method_domain.rb#16
  def validate(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  class << self
    # source://stripe//lib/stripe/resources/payment_method_domain.rb#25
...
# that wasn't allowed.
#
# source://stripe//lib/stripe/errors.rb#100
...
#
# source://stripe//lib/stripe/errors.rb#106
...
class Stripe::SetupIntent < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/setup_intent.rb#33
  def cancel(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/setup_intent.rb#42
  def confirm(params = T.unsafe(nil), opts = T.unsafe(nil)); end
  ...
  class << self
    # source://stripe//lib/stripe/resources/setup_intent.rb#60
    def cancel(intent, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/setup_intent.rb#69
    def confirm(intent, params = T.unsafe(nil), opts = T.unsafe(nil)); end

    # source://stripe//lib/stripe/resources/setup_intent.rb#78
    def verify_microdeposits(intent, params = T.unsafe(nil), opts = T.unsafe(nil)); end
  end
end
...
# webhook fails
#
# source://stripe//lib/stripe/errors.rb#111
...
class Stripe::SingletonAPIResource < ::Stripe::APIResource
  ...
  class << self
    ...
    def retrieve(params_or_opts = T.unsafe(nil), definitely_opts = T.unsafe(nil)); end
  end
end
...
class Stripe::Source < ::Stripe::APIResource
  ...
  # source://stripe//lib/stripe/resources/source.rb#42
  def detach(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  def source_transactions(*args, **_arg1, &block); end

  # source://stripe//lib/stripe/resources/source.rb#24
  def verify(params = T.unsafe(nil), opts = T.unsafe(nil)); end
  ...
  class << self
    ...
    # source://stripe//lib/stripe/resources/source.rb#33
...
class Stripe::StripeClient
  ...
  # source://stripe//lib/stripe/stripe_client.rb#180
  ...
  # source://stripe//lib/stripe/stripe_client.rb#211
  def execute_request(method, path, api_base: T.unsafe(nil), api_key: T.unsafe(nil), headers: T.unsafe(nil), params: T.unsafe(nil), usage: T.unsafe(nil)); end
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#242
  def execute_request_stream(method, path, api_base: T.unsafe(nil), api_key: T.unsafe(nil), usage: T.unsafe(nil), headers: T.unsafe(nil), params: T.unsafe(nil), &read_body_chunk_block); end

  # @return [Boolean]
  #
  # source://stripe//lib/stripe/stripe_client.rb#269
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#191
  def request; end

  # source://stripe//lib/stripe/stripe_client.rb#263
  def store_last_response(object_id, resp); end

  private

  # source://stripe//lib/stripe/stripe_client.rb#506
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#530
  def encode_body(body_params, headers); end

  # @raise [ArgumentError]
  #
  # source://stripe//lib/stripe/stripe_client.rb#430
  ...
  def execute_request_with_rescues(method, api_base, headers, usage, context); end
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#691
  def format_app_info(info); end

  # source://stripe//lib/stripe/stripe_client.rb#681
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#826
  def handle_network_error(error, context, num_retries, api_base = T.unsafe(nil)); end

  # source://stripe//lib/stripe/stripe_client.rb#892
  def log_request(context, num_retries); end

  # source://stripe//lib/stripe/stripe_client.rb#911
  def log_response(context, request_start, status, body, resp); end

  # source://stripe//lib/stripe/stripe_client.rb#942
  ...
  class << self
    ...
    #
    # source://stripe//lib/stripe/stripe_client.rb#48
    ...
    # with future non-major changes.
    #
    # source://stripe//lib/stripe/stripe_client.rb#61
    ...
    # with future non-major changes.
    #
    # source://stripe//lib/stripe/stripe_client.rb#378
    def current_thread_context; end

    # A default client for the current thread.
    #
    # source://stripe//lib/stripe/stripe_client.rb#90
    ...
    #
    # source://stripe//lib/stripe/stripe_client.rb#96
    ...
    # with future non-major changes.
    #
    # source://stripe//lib/stripe/stripe_client.rb#399
    ...
    # @return [Boolean]
    #
    # source://stripe//lib/stripe/stripe_client.rb#112
    def should_retry?(error, method:, num_retries:, config: T.unsafe(nil)); end

    # source://stripe//lib/stripe/stripe_client.rb#160
...
#
# source://stripe//lib/stripe/stripe_client.rb#279
...
#
# source://stripe//lib/stripe/stripe_client.rb#297
...
# full transparency.
#
# source://stripe//lib/stripe/stripe_client.rb#317
...
#
# source://stripe//lib/stripe/stripe_client.rb#956
...
class Stripe::StripeClient::StripeRequestMetrics
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#1039
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#1036
  def request_id; end
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#1042
  def usage; end
...
# integrations.
#
# source://stripe//lib/stripe/stripe_client.rb#978
class Stripe::StripeClient::SystemProfiler
  # @return [SystemProfiler] a new instance of SystemProfiler
  #
  # source://stripe//lib/stripe/stripe_client.rb#1010
  def initialize; end

  # source://stripe//lib/stripe/stripe_client.rb#1014
  def user_agent; end

  class << self
    # source://stripe//lib/stripe/stripe_client.rb#979
    def uname; end

    # source://stripe//lib/stripe/stripe_client.rb#994
    def uname_from_system; end

    # source://stripe//lib/stripe/stripe_client.rb#1002
...
# with future non-major changes.
#
# source://stripe//lib/stripe/stripe_client.rb#338
class Stripe::StripeClient::ThreadContext
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#342
  def active_client; end
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#346
  def default_client; end
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#364
  ...
  #
  # source://stripe//lib/stripe/stripe_client.rb#359
  ...
  # source://stripe//lib/stripe/stripe_client.rb#368
...
class Stripe::StripeConfiguration
  ...
  #
  # source://stripe//lib/stripe/stripe_configuration.rb#51
  def initialize; end
  ...
  #
  # source://stripe//lib/stripe/stripe_configuration.rb#162
  def ca_store; end
  ...
  # @return [Boolean]
  #
  # source://stripe//lib/stripe/stripe_configuration.rb#170
  def enable_telemetry?; end
  ...
  #
  # source://stripe//lib/stripe/stripe_configuration.rb#176
  def key; end
  ...
  # source://stripe//lib/stripe/stripe_configuration.rb#70
  ...
  # source://stripe//lib/stripe/stripe_configuration.rb#90
  ...
  # source://stripe//lib/stripe/stripe_configuration.rb#119
  def proxy=(proxy); end
  ...
  # source://stripe//lib/stripe/stripe_configuration.rb#129
  ...
  # source://stripe//lib/stripe/stripe_configuration.rb#124
...
class Stripe::StripeError < ::StandardError
  ...
  # @return [Boolean]
  #
  # source://stripe//lib/stripe/errors.rb#36
  ...
  # source://stripe//lib/stripe/errors.rb#40
  def to_s; end
end
...
class Stripe::StripeObject
  ...
  #   remove accessors.
  #
  # source://stripe//lib/stripe/stripe_object.rb#427
  ...
  #
  # source://stripe//lib/stripe/stripe_object.rb#370
  ...
  # @return [Boolean]
  #
  # source://stripe//lib/stripe/stripe_object.rb#411
  def respond_to_missing?(symbol, include_private = T.unsafe(nil)); end

  # source://stripe//lib/stripe/stripe_object.rb#459
  def serialize_params_value(value, original, unsaved, force, key: T.unsafe(nil)); end

  private

  # source://stripe//lib/stripe/stripe_object.rb#559
  def dirty_value!(value); end

  # Returns a hash of empty values for all the values that are in the given
  # StripeObject.
  #
  # source://stripe//lib/stripe/stripe_object.rb#570
  ...
  class << self
    ...
    #
    # source://stripe//lib/stripe/stripe_object.rb#538
...
class Stripe::Treasury::OutboundTransfer::TestHelpers < ::Stripe::APIResourceTestHelpers
  # source://stripe//lib/stripe/resources/treasury/outbound_transfer.rb#67
  def fail(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/treasury/outbound_transfer.rb#76
  def post(params = T.unsafe(nil), opts = T.unsafe(nil)); end

  # source://stripe//lib/stripe/resources/treasury/outbound_transfer.rb#85
...
module Stripe::Util
  class << self
    # @raise [TypeError]
    #
    # source://stripe//lib/stripe/util.rb#297
    def check_api_key!(key); end

    # @raise [TypeError]
    #
    # source://stripe//lib/stripe/util.rb#291
    ...
    #
    # source://stripe//lib/stripe/util.rb#261
    ...
    #
    # source://stripe//lib/stripe/util.rb#308
    def normalize_headers(headers); end

    # source://stripe//lib/stripe/util.rb#265
    def normalize_id(id); end

    # The secondary opts argument can either be a string or hash
    # Turn this value into an api_key and a set of headers
    #
    # source://stripe//lib/stripe/util.rb#277
    ...
    #
    # source://stripe//lib/stripe/util.rb#320
    def request_id_dashboard_url(request_id, api_key); end

    # Constant time string comparison to prevent timing attacks
    # Code borrowed from ActiveSupport
    #
    # source://stripe//lib/stripe/util.rb#327
    def secure_compare(str_a, str_b); end

    # source://stripe//lib/stripe/util.rb#180
    ...
    # body.
    #
    # source://stripe//lib/stripe/util.rb#212
